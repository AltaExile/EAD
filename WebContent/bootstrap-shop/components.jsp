			...
			<div id="logoArea" class="navbar">
				...
				<div class="navbar-inner">
					...
					<ul id="topMenu" class="nav pull-right">
						<liclass=""><a href="#login" role="button"
							data-toggle="modal" style="padding-right: 0<% if (!database.getID().equals("You are not logged in.")){out.println(";display: none");}%>"><span
...
================================================== -->
			...
			<div class="row-fluid">
				...
				<div class="span4">
					<h6>
						<a href="#">h6. Heading 6 <small>Small text</small></a>
					</h6>
					<h5>
						<a href="#">h5. Heading 5 <small>Small text</small>
						</a>
					</h5>
					<h4>
						<a href="#">h4. Heading 4 <small>Small text</small>
						</a>
					</h4>
					<h3>
						<a href="#">h3. Heading 3 <small>Small text</small>
						</a>
					</h3>
					<h2>
						<a href="#">h2. Heading 2 <small>Small text</small></a>
					</h2>
					<h1>
						<a href="#">h1. Heading 1 <small>Small text</small></a>
					</h1>
				</div>
			</div>
			<!-- Heading
================================================== -->
			...
			<div id="grids">
				<ul class="nav nav-tabs" id="myTab">
					...
					<li class="active"><a href="#two" data-toggle="tab">2
							Column page</a></li>
...
================================================== -->
			<div class="page-header">
				<h3>
					D. Button <small>button groups and buttons</small>
				</h3>
			</div>
			<div class="row-fluid">
				<div class="span6">
					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><code>&lt;span class="label
										label-inverse"&gt;Inverse&lt;/span&gt;</code></td>
							</tr>
						</tbody>
					</table>
				</section>
						...
						<div class="span6">
							<form class="form-horizontal">
								<fieldset>
									...
									<div class="control-group">
										<label class="control-label" for="select11">Select
											list</label>
										<div class="controls">
									...
									<div class="control-group">
										...
										<div class="controls">
											<div class="input-append">
												<input class="span10" id="appendedInputButton" size="44"
													type="text">
