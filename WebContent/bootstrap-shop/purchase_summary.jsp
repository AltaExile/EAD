...
<script>
<% 
int transID = (int) session.getAttribute("transID");
%>
</script>
</head>
<body>
	...
	<div id="mainBody">
		...
		<div class="container" >
			...
			<div class="row">
				<div class="span4">
					<p>Your purchase has been submitted. Thank you for your purchase. Please keep this
					transaction ID for your reference:<%=transID %></p>
				</div>
