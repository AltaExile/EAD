...
<body>
	...
	<div id="mainBody">
		<div class="container">
		<hr class="soften">
	<h2>What genre would you like to add?</h2>
	<hr class="soften">
			<form action="actionGenreInsert.jsp">
				<div class="span2">
					<label class="control-label" for="input14">Genre name:</label>
					<div class="controls">
						<input type="text" class="input-medium" id="input14" name="genre">
