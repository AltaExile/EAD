...
<script type="text/javascript">
	function verify(){
		String name = document.register.name.value;
		String address = document.register.mailAddress.value;
		String email = document.register.email.value;
		String contact =document.register.contactNo.value;
		String password = document.register.password.value;
		alert(contact);
...
<body>
	...
	<div class="row">
		<div class="span5">
		<div class="well" height="50px">	
			<h5>CREATE YOUR ACCOUNT</h5>
			<div style="font-size:15px"> Enter your personal details to create an account </div>
			<form name="register" method="POST" action="../Register" onsubmit="return verify()">
				...
				<label class="control-label" for="input1">Mailing Address</label>
				<div class="controls">
				  <input type="text" class="input-xlarge" name="mailAddress" placeholder="Mailing Address">
				</div>
				...
				<label class="control-label" for="input2">Contact Number</label>
				<div class="controls">
				<input type="text" class="input-medium" name="contactNo" placeholder="Contact">
				</div>
